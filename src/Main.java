...
public class Main { //classe para testar o código;
    public static void main(String[] args) throws ParseException {
        ...
        loan.dateDelivery();
        loan.receipt();
        loan.devolucao(sdf.parse("20/09/2024"), 1, 2345); //chama a função "devolução" passando uma data do tipo string como parâmetro e a converte em milissegundos, para que possa ser utilizada na operação matemática 
        //da função.
    }
